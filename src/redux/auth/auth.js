const API_SIGNUP_ENDPOINT = `https://doctor-appointment-api-u7q4.onrender.com/users`;
const API_SIGNIN_ENDPOINT = `https://doctor-appointment-api-u7q4.onrender.com/users/sign_in`;
const API_SIGNOUT_ENDPOINT = `https://doctor-appointment-api-u7q4.onrender.com/users/sign_out`;
