const API_SIGNUP_ENDPOINT = `http://127.0.0.1:3001/users`;
const API_SIGNIN_ENDPOINT = `http://127.0.0.1:3001/users/sign_in`;
const API_SIGNOUT_ENDPOINT = `http://127.0.0.1:3001/users/sign_out`;
